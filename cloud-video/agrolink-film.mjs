/**
 * AgroLink film preset → cloud-video/launch.mjs
 *
...
const promptFile = resolve(dir, "presets", "agrolink-film.md");

const env = {
  ...process.env,
  CLOUD_REPO:
    process.env.CLOUD_REPO || "https://github.com/henrysammarfo/agrolink",
  CLOUD_REF: process.env.CLOUD_REF || "main",
  CLOUD_NAME: process.env.CLOUD_NAME || "AgroLink pitch E2E film",
  CLOUD_MODEL:
